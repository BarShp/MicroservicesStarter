...
var AppComponent = /** @class */ (function () {
    function AppComponent(store, msManager) {
        this.store = store;
        this.msManager = msManager;
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.microservicesSubscription = this.store.select('microservices').subscribe(function (ms) {
            _this.microservices = ms;
        });
    };
    AppComponent.prototype.ngOnDestroy = function () {
        this.microservicesSubscription.unsubscribe();
    };
    AppComponent.prototype.pathChanged = function (path) {
        var _this = this;
        this.msManager.getMicroserviceNames(path).subscribe(function (ms) {
            _this.store.dispatch(new _reducers_microservices_microservices_actions__WEBPACK_IMPORTED_MODULE_3__["Set"]({ names: ms, path: path, pathIsValid: !!ms.length }));
        }, function (err) {
            _this.store.dispatch(new _reducers_microservices_microservices_actions__WEBPACK_IMPORTED_MODULE_3__["Set"]({ names: [], path: path, pathIsValid: false }));
        });
    };
    AppComponent.prototype.runMicroservices = function (msNames) {
...
var MicroserviceRunnerComponent = /** @class */ (function () {
    function MicroserviceRunnerComponent(store) {
        this.store = store;
        this.runMicroservicesSubmitted = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.microservicesToRun = [];
    }
    MicroserviceRunnerComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.microservicesSubscription =
            this.store.select('microservices').subscribe(function (ms) {
                _this.allAvailableMicroservices = ms.names;
                _this.clearMicroservicesToRun();
            });
        this.microservicesToRunSubscription =
            this.store.select('microservicesToRun').subscribe(function (msToRun) {
                _this.microservicesToRun = msToRun;
            });
    };
    MicroserviceRunnerComponent.prototype.ngOnDestroy = function () {
        this.microservicesSubscription.unsubscribe();
        this.microservicesToRunSubscription.unsubscribe();
    };
    MicroserviceRunnerComponent.prototype.getAvailableMicroservices = function () {
        return this.distinctArray(this.allAvailableMicroservices, this.microservicesToRun);
    };
    MicroserviceRunnerComponent.prototype.addMicroserviceToRun = function (msName) {
    ...
    MicroserviceRunnerComponent.prototype.removeMicroserviceToRun = function (msName) {
    ...
    MicroserviceRunnerComponent.prototype.addAllMicroservicesToRun = function () {
    ...
    MicroserviceRunnerComponent.prototype.clearMicroservicesToRun = function () {
    ...
    MicroserviceRunnerComponent.prototype.runMicroservices = function () {
        this.runMicroservicesSubmitted.emit(this.microservicesToRun);
    };
    MicroserviceRunnerComponent.prototype.distinctArray = function (arr, distinctByArr) {
        return arr.filter(function (value) { return !distinctByArr.includes(value); });
    };
    MicroserviceRunnerComponent.ctorParameters = function () { return [
        { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_2__["Store"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    return MicroserviceRunnerComponent;
}());
...
var PathChooserComponent = /** @class */ (function () {
    function PathChooserComponent(store) {
        this.store = store;
    ...
    PathChooserComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.microservicesSubscription = this.store.select('microservices').subscribe(function (ms) {
            _this.pathIsValid = ms.pathIsValid;
            if (_this.pathIsValid) {
                localStorage.setItem(_this.localStoragePathKey, _this.pathFormControl.value);
                _this.lastInvalidPath = null;
            }
            else {
                _this.lastInvalidPath = _this.pathFormControl.value;
            }
            _this.pathFormControl.updateValueAndValidity();
        });
    };
    PathChooserComponent.prototype.ngOnDestroy = function () {
        this.microservicesSubscription.unsubscribe();
    };
    PathChooserComponent.prototype.onSubmit = function () {
        this.pathSubmitted.emit(this.pathChooserForm.get('path').value);
    };
    PathChooserComponent.prototype.pathOkValidator = function () {
        var _this = this;
        return function (control) {
            return _this.pathIsValid ? null : { invalidPath: control.value };
        };
    };
    PathChooserComponent.prototype.sameInvalidPath = function () {
        var _this = this;
        return function (control) {
            return control.value !== _this.lastInvalidPath ? null : { sameInvalidPath: control.value };
        };
    };
    PathChooserComponent.ctorParameters = function () { return [
...
var ADD_MICROSERVICE = '[MicroservicesToRun] AddMicroservice';
var REMOVE_MICROSERVICE = '[MicroservicesToRun] RemoveMicroservice';
var ADD_MULTIPLE_MICROSERVICES = '[MicroservicesToRun] AddMultipleMicroservices';
var CLEAR_ALL = '[MicroservicesToRun] ClearAll';
var AddMicroservice = /** @class */ (function () {
    function AddMicroservice(payload) {
        this.payload = payload;
        this.type = ADD_MICROSERVICE;
    }
    AddMicroservice.ctorParameters = function () { return [
        { type: String }
    ]; };
    return AddMicroservice;
}());

var RemoveMicroservice = /** @class */ (function () {
    function RemoveMicroservice(payload) {
        this.payload = payload;
        this.type = REMOVE_MICROSERVICE;
    }
    RemoveMicroservice.ctorParameters = function () { return [
        { type: String }
    ]; };
    return RemoveMicroservice;
}());

var AddMultipleMicroservices = /** @class */ (function () {
    function AddMultipleMicroservices(payload) {
        this.payload = payload;
        this.type = ADD_MULTIPLE_MICROSERVICES;
    }
    AddMultipleMicroservices.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return AddMultipleMicroservices;
}());

var ClearAll = /** @class */ (function () {
    function ClearAll() {
        this.type = CLEAR_ALL;
    }
    return ClearAll;
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _microservices_to_run_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./microservices-to-run.actions */ "./src/app/reducers/microservices-to-run/microservices-to-run.actions.ts");


var defaultState = [];
function microservicesToRunReducer(state, action) {
    if (state === void 0) { state = defaultState; }
    switch (action.type) {
        case _microservices_to_run_actions__WEBPACK_IMPORTED_MODULE_1__["ADD_MICROSERVICE"]:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state, [action.payload]);
        case _microservices_to_run_actions__WEBPACK_IMPORTED_MODULE_1__["ADD_MULTIPLE_MICROSERVICES"]:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](state, action.payload);
        case _microservices_to_run_actions__WEBPACK_IMPORTED_MODULE_1__["REMOVE_MICROSERVICE"]:
            return state.filter(function (x) { return x !== action.payload; });
        case _microservices_to_run_actions__WEBPACK_IMPORTED_MODULE_1__["CLEAR_ALL"]:
            return defaultState;
        default:
            return state;
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Set", function() { return Set; });
var SET = '[Microservices] Set';
var Set = /** @class */ (function () {
    function Set(payload) {
        this.payload = payload;
        this.type = SET;
    }
    Set.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return Set;
}());
...
var defaultState = { names: [], path: '', pathIsValid: true };
function microservicesReducer(state, action) {
    if (state === void 0) { state = defaultState; }
    switch (action.type) {
...
var MicroserviceManagerService = /** @class */ (function () {
    function MicroserviceManagerService(http) {
        this.http = http;
        this.BASE_URL = 'http://localhost';
    }
    MicroserviceManagerService.prototype.getMicroserviceNames = function (path) {
        return this.http.get(this.BASE_URL + "/microservices?path=" + path);
    };
    MicroserviceManagerService.prototype.startMicroservices = function (path, microservices) {
        return this.http.post(this.BASE_URL + "/start", microservices.map(function (ms) { return path + "/" + ms; }));
    };
    MicroserviceManagerService.ctorParameters = function () { return [
    ...
    return MicroserviceManagerService;
}());
